...
# 	global px, py
# 	if px and py:
# 		canvas.create_line(e.x, e.y, px, py, fill=mycolor)
# 	px = e.x
# 	py = e.y
...
# canvas.bind("<ButtonRelease-1>", init)
...
# display = Entry(window, width=45, bg="yellow")
...
# row = 1
# col = 0
# for btn_txt in button_list:
# 	b = Button(window, text=btn_txt, width=width)
...
# label.pack()
# btn1 = Button(window, text="환영합니다.")
# btn1.pack()
# btn2 = Button(window, text="종료")
# btn2.pack()
# window.mainloop()
# --------------------------------------------------------
# from tkinter import *
...
# width= 28
# window = Tk()
# label = Label(window, width=width, text="현재 합계 : ")
# label.grid(row=0, column=0, columnspan=3)
# entry = Entry(window, width=width)
# entry.grid(row=1, column=0, columnspan=3)
# btn1 = Button(window, text="더하기(+)", command=plus)
# btn1.grid(row=2, column=0)
# btn2 = Button(window, text="빼기(-)", command=minus)
# btn2.grid(row=2, column=1)
# btn3 = Button(window, text="초기화", command=init)
...
# btn1 = Button(window, text="숫자 입력", command=guess)
# btn1.grid(row=2, column=0)
# btn2 = Button(window, text="다시 실행", command=replay)
# btn2.grid(row=2, column=1)
# window.mainloop()
# ----------------------------------------------------------
# from tkinter import *
...
# def ch_unit():
# 	result = 2.54 * float(entry.get())
# 	answer.config(text=str(result))

# width= 28
# window = Tk()
# title = Label(window, width=width, text="인치 -> 센치미터")
# title.grid(row=0, column=0, columnspan=2)
# guide = Label(window, width=width, text="인치 입력")
# guide.grid(row=1, column=0)
# entry = Entry(window, width=width)
# entry.grid(row=1, column=1)
# guide2 = Label(window, width=width, text="변환결과")
# guide2.grid(row=2, column=0)
# answer = Label(window, width=width)
# answer.grid(row=2, column=1)
# btn1 = Button(window, text="변환", command=ch_unit)
...
# window = Tk()
# l1 = Label(window, text="이름", width=w1)
# l1.grid(row=0, column=0)
# e1 = Entry(window, width=w2)
# e1.grid(row=0, column=1)

# l2 = Label(window, text="직업", width=w1)
# l2.grid(row=1, column=0)
# e2 = Entry(window, width=w2)
# e2.grid(row=1, column=1)

# l3 = Label(window, text="국적", width=w1)
# l3.grid(row=2, column=0)
# e3 = Entry(window, width=w2)
...
# window.mainloop()
# -----------------------------------------------------
# rock, sissor, paper game
# from tkinter import *
# from PIL import Image, ImageTk
# import random
# import time

# def ch_sub(path, widget):
...
# img1 = Image.open(def_img).resize((w, h))
# photo1 = ImageTk.PhotoImage(img1)
# usr = Label(window, image=photo1)
# usr.grid(row=0, column=0)

# op = Label(window)
# op.grid(row=0, column=1)

# img2 = Image.open(def_img).resize((w, h))
# photo2 = ImageTk.PhotoImage(img2)
# com = Label(window, image=photo2)
# com.grid(row=0, column=2)

# result = Label(window, font=("Helvetica", 12, "bold"))
# result.grid(row=1, column=1)

# btn1= Button(window, text="바위")
# btn1.grid(row=2, column=0)
# btn1.bind("<Button-1>", ch_img)
# btn2= Button(window, text="보")
# btn2.grid(row=2, column=1)
# btn2.bind("<Button-1>", ch_img)
# btn3= Button(window, text="가위")
# btn3.grid(row=2, column=2)
# btn3.bind("<Button-1>", ch_img)
...
# ----------------------------------------------------
# import shutil
# shutil.copy("writing.txt", "copy.txt")
# -----------------------------------------------------
...
# 		if ch == guess and guesses[idx] == "_":
# 			guesses[idx] = guess
# 	turns -= 1

# print("answer : {}".format(word))
# -------------------------------------------------
# write dictionary or object to file
# import pickle
# with open("dic.p", "w") as f:
# 	pickle.dump(gameOption, f)
# ------------------------------------------------
# import pickle
...
# with open("saveOption", "w") as f:
# 	pickle.dump(gameOption, f)
# -------------------------------------------------
# save dictionary with json to file
# import json
...
# 	f.write(json.dumps(gameOption, indent=4))
# --------------------------------------------------
# import pickle

# with open("saveOption", "rb") as f:
# 	data = pickle.load(f)
# 	print(data)
# ---------------------------------------------------
# from tkinter import *
...
# filemenu.add_command(label="저장하기", command=savefile)
